        ...
        <div className="row">
          ...
          <div className="col-md-3 mb-4">
            ...
            <ul className="list-unstyled">
              ...
              <li className="mb-2"><Link to="/courses/python" className="text-light text-decoration-none">Python</Link></li>
              <li><Link to="/courses/django" className="text-light text-decoration-none">Django</Link></li>
            </ul>
          </div>
