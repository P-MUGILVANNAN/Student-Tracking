  ...
  return (
    <div className="container py-5">
      <div className="text-center mb-5">
        <h1 className="display-4 fw-bold text-primary mb-3">Front End Courses</h1>
        <p className="lead text-muted">
          Master the frontend  technologies to become a job-ready Front End Developer
        </p>
        <div className="d-flex justify-content-center gap-3 mt-4">
          <span className="badge bg-light text-dark p-2">
            <i className="bi bi-people-fill me-2"></i>2,000+ Students
          </span>
          <span className="badge bg-light text-dark p-2">
            <i className="bi bi-book-half me-2"></i>50+ Lessons
          </span>
          <span className="badge bg-light text-dark p-2">
      ...
      <div className="text-center mt-5 pt-4">
        <h3 className="mb-4">Want to become a Front End Developer?</h3>
...
export default FrontendCourseView;
