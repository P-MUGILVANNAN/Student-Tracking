  ...
  return (
    <div className="container py-5">
      <div className="text-center mb-5">
        <h1 className="display-4 fw-bold text-primary mb-3">MERN Full Stack Courses</h1>
        <p className="lead text-muted">
          Master both frontend and backend technologies to become a job-ready MERN Stack Developer
        </p>
