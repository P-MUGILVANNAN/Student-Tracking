...
function CourseView() {
  const courses = [
    ...
    },
    {
      ...
      color: 'bg-primary',
      description: 'Master styling web pages with CSS3 and modern techniques',
      level: 'Beginner',
    },
    {
      id: 3,
    ...
    },
    {
      ...
      color: 'bg-info',
      description: 'Create powerful web applications with React.js',
      level: 'Intermediate',
    },
    {
      id: 6,
    ...
    },
    {
      ...
      color: 'bg-secondary',
      description: 'Understand server-side programming with Java Servlets',
      level: 'Intermediate',
    },
    {
      id: 8,
      ...
      color: 'bg-success',
      description: 'Create dynamic web content with JavaServer Pages',
      level: 'Intermediate',
    },
    {
      id: 9,
  ...
  return (
    <div className="container py-5">
      <div className="text-center mb-5">
        <h1 className="display-4 fw-bold text-primary mb-3">Our Courses</h1>
        <p className="lead text-muted">
          Explore our comprehensive curriculum designed to take you from beginner to job-ready
        </p>
        <div className="d-flex justify-content-center gap-3 mt-4">
          <span className="badge bg-light text-dark p-2">
            <i className="bi bi-people-fill me-2"></i>10,000+ Students
          </span>
          <span className="badge bg-light text-dark p-2">
            <i className="bi bi-book-half me-2"></i>150+ Lessons
          </span>
          <span className="badge bg-light text-dark p-2">
            ...
            <div className="card h-100 shadow-sm border-0 overflow-hidden">
              ...
              <div className="card-body">
                ...
                <div className="d-flex justify-content-between align-items-center">
                  ...
                  <Link
                    to={`/courses/${course.name.toLowerCase().replace(' ', '-')}`}
