        ...
        <div className="row">
          ...
          <div className="col-md-3 mb-4">
            ...
            <ul className="list-unstyled">
              ...
              <li className="mb-2"><Link to="/courses/java" className="text-light text-decoration-none">Java Programming</Link></li>
              <li><Link to="/courses/spring-boot" className="text-light text-decoration-none">Spring Boot</Link></li>
            </ul>
          </div>
