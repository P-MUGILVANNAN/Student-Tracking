...
function MeanCourseView() {
  const courses = [
    ...
    },
    {
      ...
      color: 'bg-danger',
      description: 'Create dynamic single-page applications with Angular',
      level: 'Intermediate',
    },
    {
      id: 6,
    ...
    },
    {
      ...
      icon: 'bi-diagram-3',
      color: 'bg-secondary',
      description: 'Develop fast and minimal backend APIs with Express.js',
      level: 'Intermediate',
    },
    {
      id: 8,
      ...
      icon: 'bi-database',
      color: 'bg-green',
      description: 'Store and manage data with MongoDB NoSQL database',
      level: 'Intermediate',
    },
  ];
  ...
  return (
    <div className="container py-5">
      <div className="text-center mb-5">
        <h1 className="display-4 fw-bold text-primary mb-3">MEAN Full Stack Courses</h1>
        <p className="lead text-muted">
          Master both frontend and backend technologies to become a job-ready MEAN Stack Developer
        </p>
        <div className="d-flex justify-content-center gap-3 mt-4">
          <span className="badge bg-light text-dark p-2">
            <i className="bi bi-people-fill me-2"></i>5,000+ Students
          </span>
          <span className="badge bg-light text-dark p-2">
